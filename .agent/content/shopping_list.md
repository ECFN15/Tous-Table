# 🛒 Liste Produits Atelier — Liens Directs Amazon.fr
*Ouvre chaque lien → génère ton lien affilié via le SiteStripe → donne-moi le tableau en bas*
...
## 🟢 3. SOINS PLANCHES À DÉCOUPER *(Usage alimentaire — INDISPENSABLE)*
...
## 📋 Tableau à me renvoyer après génération de tes liens affiliés

```
| ID | Nom court        | ASIN | Lien Affilié (avec ton tag)                                | Prix affiché |
|----|-----------------|------|------------------------------------------------------------|-------------|
| 1  | Osmo 3032 750ml | B002APA8RF | https://www.amazon.fr/dp/B002APA8RF?tag=MONTAG-21 | €XX,XX |
| 5  | Black Bison 500ml | B0017R3P1U | https://www.amazon.fr/dp/B0017R3P1U?tag=MONTAG-21 | €XX,XX |
| 7  | John Boos Mystery Oil | ... | ... | ... |
...
```

> 📸 **Pour l'image :** Sur chaque page produit, clique sur la photo principale → clic droit → "Copier l'adresse de l'image". Colle l'URL dans la colonne "Image" si tu veux me la donner.

---

## 🔑 Résumé des ASINs confirmés

| Produit | ASIN | Statut |
|---------|------|--------|
| Osmo Polyx-Oil 3032 (Satinée/Mat) | **B002APA8RF** | ✅ Confirmé |
| Libéron Black Bison Incolore 500ml | **B0017R3P1U** | ✅ Confirmé |
