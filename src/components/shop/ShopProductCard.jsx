...
const ShopProductCard = ({ product, darkMode = false }) => {
    ...
    return (
        ...
        >
            {/* BLOC IMAGE */}
            <div 
                className="relative aspect-[3/4] rounded-[16px] lg:rounded-[28px] overflow-hidden mb-4 bg-[#ead9c0] cursor-default group/img [clip-path:inset(1.5px_round_16px)] lg:[clip-path:inset(1.5px_round_28px)] transform-gpu"
